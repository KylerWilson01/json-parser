	...
	tests := []struct {
		...
		},
		{
			"String", `"value"`, []internal.Token{
				{Literal: "value", Type: internal.ValueString},
			},
		},
		{
		...
		},
		{
			"Simple key value object", "{\"key\": \"value\"}", []internal.Token{
				{Literal: "{", Type: internal.OpeningCurly},
				{Literal: "key", Type: internal.NameString},
		...
		},
		{
			...
			[]internal.Token{
				...
				{Literal: "key-n", Type: internal.NameString},
				{Literal: ":", Type: internal.Colon},
				{Literal: "101", Type: internal.Number},
				{Literal: ",", Type: internal.Comma},
				{Literal: "key-o", Type: internal.NameString},
				{Literal: ":", Type: internal.Colon},
				{Literal: "{", Type: internal.OpeningCurly},
				{Literal: "}", Type: internal.ClosingCurly},
				{Literal: ",", Type: internal.Comma},
		...
		},
		{
			...
			[]internal.Token{
				{Literal: "{", Type: internal.OpeningCurly},
				{Literal: "key1", Type: internal.NameString},
				{Literal: ":", Type: internal.Colon},
				{Literal: "true", Type: internal.True},
				{Literal: ",", Type: internal.Comma},
				{Literal: "key2", Type: internal.NameString},
				{Literal: ":", Type: internal.Colon},
				{Literal: "false", Type: internal.False},
				{Literal: ",", Type: internal.Comma},
				{Literal: "key3", Type: internal.NameString},
				{Literal: ":", Type: internal.Colon},
				{Literal: "null", Type: internal.Null},
				{Literal: ",", Type: internal.Comma},
				{Literal: "key4", Type: internal.NameString},
				{Literal: ":", Type: internal.Colon},
				{Literal: "value", Type: internal.ValueString},
				{Literal: ",", Type: internal.Comma},
				{Literal: "key5", Type: internal.NameString},
				{Literal: ":", Type: internal.Colon},
				{Literal: "101", Type: internal.Number},
				{Literal: "}", Type: internal.ClosingCurly},
			},
